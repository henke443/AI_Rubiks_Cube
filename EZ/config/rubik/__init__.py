...
from .env_wrapper import RubikWrapper
from .model import EfficientZeroNet
from .env import RubiksEnv


class RubikConfig(BaseConfig):
    def __init__(self):
        super(RubikConfig, self).__init__(
    ...
    def new_game(self, seed=None, save_video=False, save_path=None, video_callable=None, uid=None, test=False, final_test=False):
        if test:
            ...
            env = TimeLimit(RubiksEnv(1, 300, 5), 150)
        else:
            env = TimeLimit(RubiksEnv(1, 300, 5), 150)
