...
wrapped_env = TimeLimit(base_env, max_episode_steps=1e4)
...
action_noise = OrnsteinUhlenbeckActionNoise(
    mean=np.zeros(wrapped_env.action_space.shape[-1]), sigma=float(0.1) * np.ones(wrapped_env.action_space.shape[-1]))
